...
next_page_title: "Pröva om argument är invändningar"
next_page_url: "test-arguments-qualify-as-objections.html"
prev_page_title: "Beskriv organisatoriska drivkrafter"
...
Samtycke inbjuder människor till att (åtminstone) vara rimliga och öppna för möjligheter till lärande och förbättring. När man tillämpar [-principen för samtycke](principle-consent.html) är man överens om att avsiktligt söka efter [invändningar](objection.html).
...
Inte alla argument som framförts är invändningar, men de kan avslöja [oro](objection.html):
...
Som en allmän rekommendation, försök att slutföra detta steg med mötesdeltagarna asynkront, [före mötet](prepare-for-meetings.html). Det ger dig möjlighet att göra förbättringar i förväg och undvika att slösa värdefull mötestid.
...
(Se också [Pröva om argument är invändningar](test-arguments-qualify-as-objections.html)).
...
Se mönstret [Lös invändningar](resolve-objections.html) för detaljer.

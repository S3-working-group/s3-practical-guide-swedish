...
next_page_title: "Mönstren"
next_page_url: "patterns.html"
prev_page_title: "Överenskommelser"
...
Medan ett beslut med kortsiktig och liten påverkan lätt kan ändras spontant, tjänar överenskommelser med större påverkan och som begränsar människors beteende och aktivitet, ofta på ett större deltagande och en tydlig och avsiktlig [beslutsprocess](consent-decision-making.html). Dessa överenskommelser omfattar men är inte begränsade till frågor som: strategi, prioriteringar, fördelning av ansvar och makt att påverka, arbetsprocesser och många beslut om produkter och tjänster.
